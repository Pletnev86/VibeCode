...
**VibeCode** - это десктопное приложение на Electron, которое позволяет использовать локальные AI модели (через LM Studio) и внешние провайдеры (OpenRouter, GPT API) для автономной разработки программного обеспечения.

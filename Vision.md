# Vision — Local Cursor X

## 1. Цель проекта

Создать минимальный рабочий каркас Local Cursor X, который:
...
Local Cursor X должен стать автономной системой разработки, которая:
...
*Документ создан на основе Visionstart — стартового Vision для Local Cursor X*
